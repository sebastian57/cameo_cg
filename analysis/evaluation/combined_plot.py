...
from analysis.evaluation.evaluator    import Evaluator             # noqa: E402
from analysis.evaluation.visualizer   import LossPlotter           # noqa: E402
...
def main():
    ...
    loader = DatasetLoader(str(data_path), max_frames=None, seed=config.get_seed(), dynamic_box=config.dynamic_box_enabled())
